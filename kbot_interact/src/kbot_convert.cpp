...
#include "kbot_moveit/ArmJointState.h"
#include "math.h"

kbot_moveit::ArmJointState arm_steps;
kbot_moveit::ArmJointState total;
...
void cmd_cb(const sensor_msgs::JointState& cmd_arm)
{
  ...
  // ros::Publisher pub = nh.advertise<kbot_moveit::ArmJointState>("joint_steps",50);
...
{
  ros::init(argc, argv, "kbot_moveit");
  ros::NodeHandle nh;
